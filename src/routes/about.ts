...
export const about: RouteHandler = (req, ctx) => {
    ...
    <p>The <strong>Encyclopedia of AI Hallucinations</strong> is a
       ...
       systems. EAH aims to be the OEIS of AI failures: a permanent, citable,
       structured record. Just as the
       <a href="https://oeis.org/">On-Line Encyclopedia of Integer Sequences</a>
       became the go-to reference for integer sequences, EAH aims to be the
    ...
    <h2>Our vision</h2>
    <p>EAH started because hallucinations were scattered across social media,
