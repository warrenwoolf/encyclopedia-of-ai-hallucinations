...
export const terms: RouteHandler = (req, ctx) => {
    ...
    <p>ENAIH is a public reference database. You may browse entries freely.
    ...
    <p>Submitted prompts and outputs are documented for research and educational
       ...
       have the right to share the content and grant ENAIH a non-exclusive license
       to publish it.</p>
